            ...
            <form onSubmit={handleEmailLogin} className="space-y-5">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-white/60 dark:bg-black/40 border border-gray-700/50 rounded-lg px-4 py-3 text-white outline-none focus:border-[#8B5CF6] focus:ring-1 focus:ring-[#8B5CF6] transition-all"
                  required
                />
              </div>
              <div>
    ...
    <div className="min-h-screen bg-[#0B0C10] text-white flex flex-col font-sans">
      ...
      <div className="px-8 py-4 bg-[#0F1014] border-b border-black/10 dark:border-white/5 flex justify-between items-center sticky top-0 z-50">
        ...
        <div className="flex items-center gap-6">
          <a href="/" className="text-sm font-medium text-gray-400 hover:text-black dark:hover:text-white transition-colors">Home</a>
          ...
          <button onClick={logout} className="flex items-center gap-2 text-gray-400 hover:text-black dark:hover:text-white transition-colors text-xs font-medium bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 px-3 py-1.5 rounded-lg border border-black/10 dark:border-white/5">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea 
                  ...
                  rows="5"
                  className="w-full bg-white/60 dark:bg-black/40 border border-gray-700/50 rounded-lg p-3 text-white outline-none focus:border-[#8B5CF6] focus:ring-1 focus:ring-[#8B5CF6] transition-all text-sm resize-none"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#0F1014] p-6 rounded-2xl border border-black/10 dark:border-white/5 shadow-xl">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-3 mt-2">
                ...
                <button 
                  onClick={clearBoard}
                  className="bg-white/60 dark:bg-black/40 border border-gray-700/50 text-gray-400 text-xs py-2 rounded-lg hover:bg-black/5 dark:hover:bg-white/5 transition-colors uppercase tracking-wider font-medium flex items-center justify-center gap-2"
                >
